...
// Refactor the GameSearchBy component into a function component
      ...
      {/*games from database  */}
        {games.map((game) => (
          <div className="my-4 flex-col  hover:translate-x-[.1rem] duration-150 bg-slate-50 text-gray-600 p-2 rounded-lg "key={game.game_id}>
            ...
            {deleteMode && <button onClick={()=>(deleteGameById(game.game_id))}><MdDelete className='text-red-600 text-xl hover:scale-[1.1] hover:text-red-300 duration-150'/></button>}
            </div>
